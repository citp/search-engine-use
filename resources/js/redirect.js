...
(async () => {
    if(getBrowserIsChromeOrEdge()) {
        if(studyPhase == "initial") {
            window.location.href = "https://princetonsurvey.az1.qualtrics.com/jfe/form/SV_etdT5Iu2fuMKoyG";
        } else {
            window.location.href = "https://princetonsurvey.az1.qualtrics.com/jfe/form/SV_2tVRzUgJ8w9msLA";
        }
    } else {
        ...
        window.location.href = "http://search-engine-use.cs.princeton.edu/ineligible";
    }
})();
