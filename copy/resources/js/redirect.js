...
(async () => {
    ...
    if(getBrowserIsChromeOrEdge()) {
        if(studyPhase == "initial") {
            window.location.href = `https://princetonsurvey.az1.qualtrics.com/jfe/form/SV_81fnUhgl1gwBen4?PROLIFIC_PID=${prolificId}`;
        } else {
            window.location.href = `https://princetonsurvey.az1.qualtrics.com/jfe/form/SV_cZ2ergfJAAXNuAe?PROLIFIC_PID=${prolificId}`;
        }
    } else {
